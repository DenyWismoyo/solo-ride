      ...
      <Card className="w-full max-w-md bg-zinc-900/90 border-zinc-800/90 shadow-2xl backdrop-blur-xl rounded-3xl z-10">
        <CardContent className="p-7 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-2xl font-black text-white tracking-tight">Buat Akun Baru</h2>
          ...
          <form onSubmit={handleRegister} className="space-y-3.5">
            ...
            <Button 
              type="submit" 
              className={`w-full h-12 text-white font-bold rounded-xl shadow-lg text-sm mt-2 ${
                role === "driver"
