  ...
  const handleReject = async (reason: string) => {
    ...
    try {
      await updateDoc(doc(db, COLLECTIONS.ORDERS, orderId), {
        ...
        rejectedByDinasName: userData?.displayName || "Petugas Dispertan",
      ...
      if (user) {
        await writeAuditLog({
          ...
          action: "rejected",
          actorId: user.uid,
          actorName: userData?.displayName || "Petugas Dispertan",
  ...
  const handleResolvePuskeswan = async (orderId: string) => {
    ...
    try {
      await updateDoc(doc(db, COLLECTIONS.ORDERS, orderId), {
        ...
        verifiedByDinasName: userData?.displayName || "Petugas Dispertan",
        updatedAt: serverTimestamp()
      });
