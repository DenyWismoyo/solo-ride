  ...
  const handleReject = async (reason: string) => {
    ...
    try {
      await updateDoc(doc(db, COLLECTIONS.ORDERS, orderId), {
        ...
        rejectedByDinasName: userData?.displayName || "Petugas DPMPTSP",
      ...
      if (user) {
        await writeAuditLog({
          ...
          action: "rejected",
          actorId: user.uid,
          actorName: userData?.displayName || "Petugas DPMPTSP",
  ...
  const handleApproveMpp = async (orderId: string) => {
    ...
    try {
      await updateDoc(doc(db, COLLECTIONS.ORDERS, orderId), {
        ...
        verifiedByDinasName: userData?.displayName || "Petugas DPMPTSP",
        updatedAt: serverTimestamp()
      });
